  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Medical Disclaimer */}
        <div className="mb-12 p-4 bg-yellow-900 border-l-4 border-yellow-400 rounded-r-lg max-w-3xl mx-auto">
          <div className="flex">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* CBC Analysis Card */}
          <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-semibold text-white mb-4">CBC Test Analysis</h2>
            </div>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-3">Non-Invasive Camera Scan</h2>
            </div>
